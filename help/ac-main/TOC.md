...
+ Création de contenu {#content-creation}
   + Email {#email}
      ...
      + {hide-from-toc}[Définir du contenu d’e-mail interactif avec AMP](/help/content-creation/design-interactive-email-content-with-amp.md)
...
+ Envoyer des messages{#sending-messages}
   ...
   + Notifications push {#push}
      + {hide-from-toc}[Installer le canal des applications mobiles](/help/send-messages/mobile/install-the-mobile-app.md)
      + {hide-from-toc}[Configurer le canal push à l’aide du SDK mobile Experience Platform](/help/send-messages/mobile/configure-push-using-aep-mobile-sdk.md)
...
+ Se connecter à d’autres solutions {#connect}
   ...
   + {hide-from-toc}[Intégrer Microsoft Dynamics 365](/help/connect/dynamics365-integration.md)
+ Reporting {#reporting}

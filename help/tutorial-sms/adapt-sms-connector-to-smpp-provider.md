...
description: Découvrez comment affiner les paramètres de vos SMS pour gérer les limites de connexion, configurer le débit maximal, la fenêtre d’envoi et le cryptage avec TLS.
feature: SMS
...
![S’applique à V7, V8](../assets/V7-V8-stamp.png)

...
* **[Configurer un compte SMS pour un fournisseur SMPP standard](/help/tutorial-sms/set-up-account-for-standard-smpp-provider.md)**
...
* **[Adapter le connecteur SMS à votre fournisseur SMPP](/help/tutorial-sms/adapt-sms-connector-to-smpp-provider.md)**
  *Découvrez comment régler les paramètres de vos SMS pour gérer les limites de connexion. Découvrez comment configurer le débit maximal, une fenêtre d’envoi et le chiffrement avec TLS.*

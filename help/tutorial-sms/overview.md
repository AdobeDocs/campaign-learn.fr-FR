...
* **[Adapter le connecteur SMS à votre fournisseur SMPP](/help/tutorial-sms/adapt-sms-connector-to-smpp-provider.md)**
  *Découvrez comment affiner les paramètres de vos SMS pour gérer les limites de connexion. Découvrez comment configurer le débit maximal, une fenêtre d’envoi et le chiffrement avec TLS.*

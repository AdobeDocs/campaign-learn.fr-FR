...
+ [Tutoriel - Utilisation des API SOAP Campaign](/help/tutorial-using-soap-apis/introduction.md)
...
+ Etape 4 - Créer un condensé de contenu avec un workflow {#content-digest}
   + [Création d’un condensé de contenu avec un workflow](/help/tutorial-using-soap-apis/create-a-content-digest-overview.md)
